...
class Alumno extends Controller
{
    ...
    public function update($param = [])
    {
        ...
        // VALIDACIÓN BÁSICA (Añade esto)
        if (empty($curso_id)) {
            // Si el curso viene vacío, redirigir atrás con un error o manejarlo
            // Por ahora, detendremos la ejecución para que veas el aviso
            die("Error: Debes seleccionar un curso válido.");
        }
