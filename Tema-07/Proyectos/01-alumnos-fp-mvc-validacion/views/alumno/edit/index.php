        ...
        <main>
            ...
            <form action="<?=  URL ?>alumno/update/<?= $this->id ?>" method="POST">
                ...
                <a class="btn btn-secondary" href="<?=  URL ?>alumno" role="button"
                    onclick="return confirm('Confimar cancelación alumno')">Cancelar</a>
                <button type="reset" class="btn btn-secondary" onclick="return confirm('Confimar reseteo alumno')">Limpiar</button>
