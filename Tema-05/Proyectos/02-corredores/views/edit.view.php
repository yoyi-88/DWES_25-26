        ...
        <main>
            ...
            <form action="update.php?id=<?=  $corredor_id ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="sexo" id="sexoOtro" value=" "
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="fecha_nacimiento" value="<?= $corredor->fechaNacimiento ?>" required>
                </div>
                ...
                <a class="btn btn-secondary" href="index.php" role="button"
                    onclick="return confirm('Confimar cancelación corredor')">Cancelar</a>
                <button type="reset" class="btn btn-secondary" onclick="return confirm('Confimar reseteo corredor')">Limpiar</button>
                <button type="submit" class="btn btn-primary">Guardar Corredor</button>
            </form>
