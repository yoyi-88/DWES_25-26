...
<body>
    ...
    <div class="container mt-3">
        ...
        <main>
            ...
            <legend>Formulario Ver Corredor</legend>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="fecha_nacimiento" value="<?= $corredor->fechaNacimiento ?>" readonly>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="categoria_id" readonly>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="club_id" readonly>
