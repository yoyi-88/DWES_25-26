...
<head>
    ...
    <!-- Título adaptado a Gesbank -->
    <title> Proyecto 5.2 - Panel Control de Cuentas - GESBANK</title>
        ...
        <main>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4">Total Cuentas: <?= $cuentas->rowCount() ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
