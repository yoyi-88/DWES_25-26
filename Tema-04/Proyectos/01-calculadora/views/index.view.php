        ...
        <main>
            ...
            <form action="calculadora.php" method="GET">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="valor1" name="valor1" step="0.01" placeholder="0.0">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Valor 2</label>
                    <input type="number" class="form-control" id="valor2" name="valor2" step="0.01" placeholder="0.0">
                </div>
                ...
                <div class="btn-group" role="group">
                    ...
                    <button type="submit" class="btn btn-warning" name="operacion" value="Dividir">Dividir</button>
                </div>
