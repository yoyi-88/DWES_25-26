    ...
    <div class="container mt-3">
        ...
        <main>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="id" name="id" value="<?= $alumno->id ?>" disabled>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="apellidos" name="apellidos" value="<?= $alumno->apellidos ?>" disabled>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="f_nacimiento" name="f_nacimiento" value="<?= $alumno->f_nacimiento ?>" disabled>
            </div>

            <div class="mb-3">
                <label for="curso" class="form-label">Curso</label>
                <input type="text" class="form-control" id="curso" value="<?= $cursos[$alumno->curso] ?>" disabled>
            </div>

            <div class="mb-3">
                <label for="asignaturas" class="form-label">Asignaturas</label>
                <input type="text" class="form-control" id="asignaturas" value="<?= implode(", ", Class_tabla_alumnos::asignaturas_indices_a_nombres($alumno->asignaturas)); ?>" disabled>
            </div>
