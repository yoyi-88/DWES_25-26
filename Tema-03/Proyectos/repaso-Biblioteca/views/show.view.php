    ...
    <div class="container mt-3">
        ...
        <main>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput" value="<?=  $libro['titulo']; ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Autor</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" value="<?=  $libro['autor']; ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput3" class="form-label">Género</label>
                <input type="text" class="form-control" id="formGroupExampleInput3" value="<?=  $libro['genero']; ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput4" class="form-label">Copias</label>
                <input type="text" class="form-control" id="formGroupExampleInput4" value="<?=  $libro['copias']; ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput5" class="form-label">Publicación</label>
                <input type="text" class="form-control" id="formGroupExampleInput5" value="<?=  $libro['publicacion']; ?>" readonly>
            </div>
